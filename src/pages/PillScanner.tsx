  ...
  return (
    <div className="min-h-screen bg-dark-primary p-6 safe-area-bottom pb-32">
      <header className="flex items-center justify-between mb-8">
        ...
        <h1 className="text-xl font-black italic uppercase tracking-tighter text-white">Vision AI Scanner</h1>
        <div className="w-10" />
      </header>
      ...
      <div className="max-w-md mx-auto space-y-8">
        <section className="text-center space-y-3">
          ...
          <h2 className="text-2xl font-black tracking-tight uppercase italic text-white">Pill Verifier</h2>
        ...
        <div className="relative aspect-square w-full max-w-[300px] mx-auto group">
           <div 
             ...
             className={cn(
               ...
               image ? "border-primary/50" : "border-white/10 hover:border-primary/30 bg-white/5"
             )}
           >
              {image ? (
        ...
        <div className="space-y-4">
           <button 
             ...
             className="w-full h-16 bg-primary text-white rounded-2xl font-black uppercase tracking-[0.2em] shadow-xl shadow-primary/20 flex items-center justify-center gap-3 disabled:opacity-50"
           >
               ...
               <div className={cn(
                 ...
                 result.match ? "bg-safe/5 border-safe/20" : "bg-danger/5 border-danger/20"
                  ...
                  <div className="flex items-center gap-4">
                     ...
                     <div>
                        <h3 className="text-xl font-black uppercase italic leading-none text-white">{result.pillName}</h3>
                  ...
                  <div className="space-y-4">
                     <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                        <p className="text-[9px] font-black uppercase tracking-widest text-zinc-500 mb-1">AI Visual analysis</p>
                        <p className="text-sm font-medium text-zinc-300 leading-relaxed">{result.description}</p>
                     </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-2">
                     <div className="text-center p-3 bg-black/20 rounded-xl">
                        <p className="text-[8px] font-black uppercase text-zinc-500 mb-1">Shape</p>
                        <p className="text-xs font-bold text-white uppercase">{result.visuals?.shape}</p>
                     </div>
                     <div className="text-center p-3 bg-black/20 rounded-xl">
                        <p className="text-[8px] font-black uppercase text-zinc-500 mb-1">Color</p>
                        <p className="text-xs font-bold text-white uppercase">{result.visuals?.color}</p>
                     </div>
                  </div>
               </div>

               <div className="flex gap-3">
                  <button onClick={() => setImage(null)} className="flex-1 py-4 bg-white/5 rounded-2xl text-[10px] font-black uppercase tracking-widest">Rescan</button>
                  <button className="flex-1 py-4 bg-primary text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/20">Save Result</button>
               </div>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <div className="p-6 bg-info/5 rounded-3xl border border-info/10 flex gap-4 items-start">
          ...
          <div className="space-y-1">
            <h4 className="text-xs font-bold text-white uppercase tracking-widest">Vision Disclaimer</h4>
