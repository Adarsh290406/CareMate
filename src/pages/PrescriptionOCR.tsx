  ...
  return (
    <div className="min-h-screen bg-dark-primary p-6 safe-area-bottom pb-32">
      <header className="flex items-center justify-between mb-8">
        ...
        <h1 className="text-xl font-black italic uppercase tracking-tighter text-white">OCR Smart Scanner</h1>
        <div className="w-10" />
      </header>
      ...
      <div className="max-w-md mx-auto space-y-8">
        <section className="text-center space-y-3">
          ...
          <h2 className="text-2xl font-black tracking-tight uppercase italic text-white">Prescription AI</h2>
          ...
          <div className="space-y-6">
            <div 
              ...
              className={cn(
                ...
                image ? "border-success/50" : "border-white/10 hover:border-success/30 bg-white/5"
              )}
            >
              {image ? (
                ...
                <>
                  ...
                  <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 text-center px-8">
            ...
            <button 
              ...
              className="w-full h-16 bg-success text-white rounded-2xl font-black uppercase tracking-[0.2em] shadow-xl shadow-success/20 flex items-center justify-center gap-3 disabled:opacity-50"
            >
          ...
          >
             <div className="card p-8 border-success/20 bg-success/5 space-y-6">
                <div className="flex items-center gap-4">
                   ...
                   <div>
                      <h3 className="text-xl font-black uppercase italic leading-none text-white">Extraction Successful</h3>
                ...
                <div className="space-y-4">
                   {result.medications.map((med: any, i: number) => (
                     <div key={i} className="p-5 bg-white/5 rounded-[2rem] border border-white/5 space-y-3">
                        <div className="flex items-center justify-between">
                           <div className="flex items-center gap-3">
                              <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-success">
                                 <Pill size={20} />
                              </div>
                              <span className="font-black text-white">{med.name}</span>
                           </div>
                           <span className="text-[10px] font-black uppercase text-zinc-500">{med.dosage}</span>
                        </div>
             ...
             <div className="flex gap-3">
                <button 
                  ...
                  className="flex-1 h-14 bg-white/5 rounded-2xl text-[10px] font-black uppercase tracking-widest"
                >
                  Discard
                </button>
                <button 
                  ...
                  disabled={saving}
                  className="flex-1 h-14 bg-success text-white rounded-2xl font-black uppercase tracking-widest shadow-lg shadow-success/20 flex items-center justify-center gap-2"
                >
        ...
        <div className="p-6 bg-info/5 rounded-3xl border border-info/10 flex gap-4 items-start">
          ...
          <div className="space-y-1">
            <h4 className="text-xs font-bold text-white uppercase tracking-widest">OCR Accuracy</h4>
