  ...
  return (
    <div className="min-h-screen bg-dark-primary p-6 safe-area-bottom">
      <header className="flex items-center justify-between mb-8">
        ...
        <h1 className="text-xl font-black italic uppercase tracking-tighter text-white">Impact Simulator</h1>
        <div className="w-10" />
      </header>
      ...
      <div className="max-w-md mx-auto space-y-8">
        <section className="text-center space-y-3">
          ...
          <h2 className="text-2xl font-black tracking-tight uppercase italic text-white">What if I miss?</h2>
              ...
              {medications.map(m => (
                <button 
                  ...
                  className={cn(
                    ...
                    selectedMed === m.name ? "bg-danger/10 border-danger text-white" : "bg-white/5 border-white/5 text-text-secondary"
                  )}
                >
                   <div className="flex items-center gap-4">
                      <div className={cn(
                        "w-10 h-10 rounded-xl flex items-center justify-center",
                        selectedMed === m.name ? "bg-danger/20 text-danger" : "bg-white/10"
                      )}>
                         <Zap size={18} />
                      </div>
            ...
            >
               <div className="card p-8 border-danger/20 bg-danger/5 space-y-6">
                  <div className="flex items-center gap-4">
                     ...
                     <div>
                        <h3 className="text-xl font-black uppercase italic leading-none text-white">Projected Impact</h3>
                  ...
                  <div className="space-y-4">
                     <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                        ...
                        <p className="text-sm font-medium text-zinc-300 leading-relaxed">{simulation.impact}</p>
                     </div>
                     ...
                     <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                        ...
                        <p className="text-sm font-medium text-zinc-300 leading-relaxed italic">"{simulation.recovery}"</p>
                     </div>
                  </div>

                  <div className="flex items-center gap-4 p-4 bg-black/40 rounded-2xl">
                     <div className="text-center flex-1">
                        <p className="text-[9px] font-black uppercase text-zinc-500 mb-1">Efficacy Drop</p>
                        <p className="text-xl font-black text-danger">{simulation.efficacyDrop}%</p>
                     </div>
                     <div className="w-px h-8 bg-zinc-800" />
                     <div className="text-center flex-1">
                        <p className="text-[9px] font-black uppercase text-zinc-500 mb-1">Safety Window</p>
               ...
               <div className="p-6 bg-info/5 rounded-3xl border border-info/10 flex gap-4 items-start">
                 ...
                 <div className="space-y-1">
                   <h4 className="text-xs font-bold text-white uppercase tracking-widest">CareMate Insight</h4>
